...
let edad = [15, 45, 29];
let coloresFavoritos = ["verde", "rojo", "azul"];
/******************************************************************************************* */
...
/*************************************************************************************************************************** */
// agrupación de variables para clasificar por listados dependiendo de la mayoría de edad como criterio.
let menoresEdad = [];
let mayoresEdad = [];
...
var people = (name, lastName, edad, colors) => {
    let fullNames = [];
    for (let i = 0; i < name.length; i++) {
        fullNames.push({ name: name[i], lastName: lastName[i], edad: edad[i], colors: colors[i] });
    }
    return fullNames;
}
...
//en esta función separamos en dos arrays a las personas que son mayor de edad y a las que son menor de edad.
var classifyAges = people => {
...
recuerda que están declaradas con la variable LET*/
/********************************************************************************************/
const peopleArray = (people(nombresM, apellidos, edad, coloresFavoritosM));
classifyAges(peopleArray);
/********************************************************************************************/
